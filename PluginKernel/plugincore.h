...
private:
	...
	enum class presetSelectionEnum { full,medium,quiet };	// to compare: if(compareEnumToInt(presetSelectionEnum::full, presetSelection)) etc... 

	// --- Meter Plugin Variables
	float leftOutMeter = 0.f;
	float rightOutMeter = 0.f;
